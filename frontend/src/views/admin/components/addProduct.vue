<template>
    <form class="inputs" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <label for="prod_category">Hảng</label>
        ...
        <div class="form-group">
            <label for="prod_desc">Ghi Chú</label>
